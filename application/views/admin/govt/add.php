...
<br/><br/><br/><br/><div class="row">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal bucket-form" method="post" action="<?php echo base_url() ?>govt/save" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label class="col-sm-3 control-label">Govt.Circular PDF File</label>
                        <div class="col-sm-4">
